...
namespace Drupal\Tests\schemadotorg_subtype\Unit;
...
/**
 * @coversDefaultClass \Drupal\schemadotorg_subtype\Breadcrumb\SchemaDotOrgSubtypeBreadcrumbBuilder
 * @group schemadotorg
 */
class SchemaDotOrgSubtypeBreadcrumbBuilderTest extends UnitTestCase {
  ...
  /**
   * Tests SchemaDotOrgSubtypeBreadcrumbBuilder::applies().
   *
   * @param bool $expected
   *   SchemaDotOrgSubtypeBreadcrumbBuilder::applies() expected result.
  ...
  public function testApplies($expected, $route_name = NULL) {
    $breadcrumb_builder = $this->getMockBuilder('\Drupal\schemadotorg_subtype\Breadcrumb\SchemaDotOrgSubtypeBreadcrumbBuilder')
      ->onlyMethods([])
      ->getMock();
   ...
   *   - SchemaDotOrgSubtypeBreadcrumbBuilder::applies() expected result.
   *   - SchemaDotOrgSubtypeBreadcrumbBuilder::applies() route name.
   */
  public function providerTestApplies() {
    return [
      [FALSE],
      [FALSE, 'schemadotorg'],
      [TRUE, 'schemadotorg_subtype.settings'],
    ];
  }
