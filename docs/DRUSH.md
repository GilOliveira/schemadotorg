...
drush schemadotorg:create-type -y node:Person node:Organization node:Place node:Event node:CreativeWork
...
drush schemadotorg:delete-type -y --delete-entity node:Person node:Organization node:Place node:Event node:CreativeWork
```
