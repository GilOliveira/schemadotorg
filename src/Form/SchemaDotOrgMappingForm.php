...
class SchemaDotOrgMappingForm extends EntityForm {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['label'] = [
      ...
      '#description' => $this->t('Label for the Schema.org mapping.'),
      '#required' => TRUE,
    ];
    ...
    $form['id'] = [
      ...
      '#machine_name' => [
        'exists' => '\Drupal\schemadotorg\Entity\SchemaDotOrgMapping::load',
      ],
    ...
    $form['description'] = [
      ...
      '#description' => $this->t('Description of the Schema.org mapping.'),
    ];
